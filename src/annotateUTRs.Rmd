...
TO FIX: Parent of CDS should be the same tx.
...
UPDATE: didn't work, featureCounts crashed ofr an unknown reason.

```{r gff_collected_featureCounts_workaround}
...
```{r txgff_collected,dependson="gff_collected"}
txpartlength_mRNA <- 
    gff_collected %>%

...
outfile_longest_or_CDSext <- here::here(
    "out",
    "longest_full-ORF_ypd_plus_other_fixed_UTR_length_transcripts.gff3")
...
* Make gff with CDS, introns, coding transcripts, UTRs, only
* Make approximate txs with introns removed?
* Update annotation for Ssd1 genome browser figures

...
ssd1_data_bayne2020 <-
    here::here("data","Ssd1_targets",
               "Ssd1_targets_TPMratio5x_30C_EW30Mar2020.txt") %>%
    readr::read_tsv()
...
# Venn diagram of intersections with our data

Ugly yet effective.

```{r venn_hogan_jansen_hose_bayne,dependson=c("Hogan_targets","Jansen_targets","Hose_targets"),fig.width=4,fig.height=3.8}
